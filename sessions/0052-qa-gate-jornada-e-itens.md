...
- [ ] **C2 (GL-2 — gate de HP):** `GET /battle` e `POST /battle/new` com time de 6 **todo
      ...
      zerado batalha. — prova: `test/journey_service_test.rb`
...
| C2 (GL-2) | `./scripts/test -n /battle_ready|battle_blocked_when_all_hp_zero/` | time de 6 todo zerado → `/battle` mostra "cure no Poke Center" + CTA | |
