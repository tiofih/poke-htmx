...
- **S7 — Loop Implementador↔Revisor na fase 2c.** Ao fim da fase 2 (TDD), o **Revisor**
  ...
  **Teto: 3 rodadas** — sem convergir, **escalar ao usuário (S3)**. Só o Implementador edita — e, com `> Equipe:`
  (perfil `--with-especialistas`), os especialistas **nas suas lanes**; o Revisor nunca. Vai à validação (fase 3) apenas com veredito `Aprovado`.
