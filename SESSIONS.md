...
**Próxima sessão (2026-09-21):** **0091-t3-t4-rodada3** (refinada, **fase 2 pendente**) — T3/T4 (achados `low` da rodada 3 da 0089): reindentar `<p class="rewards">` em `battle.erb`/`_strike_result.erb` + assert exato da copy de XP em `battle_routes_test.rb:793-794`; `> Reprodução: manual`, `> E2E: sim` (battle-log.spec.ts).
...
| 0091 | T3+T4 rodada 3 da 0089: reindentar `<p class="rewards">` + assert exato de XP em derrota | Refinamento | Concluída em 2026-09-21, fase 2 pendente |
