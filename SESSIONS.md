...
no `BattleService`; caminho `rater`/`moves_fetcher` intacto; banda preservada. Depois da
0050: organizar o resto do QA (Q2–Q5) e a fila (J2, J4, D4, M2) — a critério do usuário.
