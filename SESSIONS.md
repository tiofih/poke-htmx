...
| 0036 | J1 — seleção inicial de time: fim do dropdown (lista clicável sprite+nome+Add, pool total 20/página + destaques "Iniciais") + tela de entrada da jornada (gate battle/mart/center até time de 6, marcador `user_state` + derivado do time) | Implementação | Concluída — passos 1–6 + ajustes S3 (só formas base; 27 iniciais gen 1–9 fora da listagem; suíte 611/1936, lint 0), aguardando revalidação do usuário |
